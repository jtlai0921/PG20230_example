...
// 這個輔助類別是用來擴充 Java 內附的色彩名稱用的. Color 類別麻煩之處在於
// 它只有幾個內建的色彩名稱: black, blue, cyan, darkGray, gray, green,
// lightGray, magenta, orange, pink, red, white 與 yellow.  
// 相對之下, JacquieColor, 提供了將近 90 種不同的色彩名稱 -- floralWhite,
// papayaWhip, 諸如此類 -- 它們的名稱來源是從 X Windows/Motif 函式庫的
// "標準" 名稱而來的.
//
// 這個類別的使用方法有幾種:
//
// 1.  您可以跟使用 Color 類別一樣使用它, 例:
//
//     myPanel.setBackground(JacquieColor.snow);
//
// 2.  您可建立一個應用程式專屬的類別, 然後根據功能為色彩重新命名 - 例:
//
//     warningMessageRed, exitButtonBlue, 諸如此類.
